...
function tmpl($api, $cmp, $slotset, $ctx) {
  ...
  return [api_element("div", {
    ...
    key: 1
  }, [api_dynamic($cmp.formattedCount)])])];
}
...
class Button extends BaseLightningElement {
  ...
  get formattedCount() {
    ...
    return int < 1000 ? int : `${(int / 1000).toFixed(1)}k`.replace('.0k', 'k');
...
function tmpl$1($api, $cmp, $slotset, $ctx) {
  ...
  return [api_element("div", {
  ...
  })) : null, $cmp.showWidget ? api_element("div", {
    classMap: {
      "bottom-section": true
    },
    key: 6
    ...
    key: 5
  }, [api_text("Brought to you with \u2661 by\xA0"), api_element("a", {
    attrs: {
      "target": "_blank",
      "href": "https://github.com/fostive"
    },
    key: 4
  }, [api_text("Fostive")])])]) : null, $cmp.showOptions ? api_element("h1", {
    key: 7
