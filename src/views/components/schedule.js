    ...
    <div class="day">
        ...
        <div class="day-content">
            ...
            <div class="hallway track">
                <h3>Hallway Track</h3>
                <p>There are two ways to spend time when you're not watching the talks: our virtual event space in Gather and . Read on for more information on both places!</p>
